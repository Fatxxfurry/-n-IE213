    ...
    <div className="flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      >
        <h2 className="mt-6 text-center text-3xl font-extrabold text-emerald-400">
          {t("signup_page.title", { defaultValue: "Create your account" })}
        </h2>
      </motion.div>
        ...
        <div className="bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              >
                {t("signup_page.name_label", { defaultValue: "Full name" })}
              </label>
            ...
            <div>
              <label
                ...
                className="block text-sm font-medium text-gray-300"
              >
                {t("signup_page.password_label", { defaultValue: "Password" })}
              </label>
              <div className="mt-1 relative rounded-md shadow-sm">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            ...
            <div>
              <label
                ...
                className="block text-sm font-medium text-gray-300"
              >
                {t("signup_page.confirm_password_label", {
              ...
              {loading ? (
                <>
                  <Loader
                    ...
                    aria-hidden="true"
                  />
                  {t("signup_page.loading", { defaultValue: "Loading..." })}
                </>
              ) : (
                <>
                  <UserPlus className="mr-2 h-5 w-5" aria-hidden="true" />
                  {t("signup_page.signup_button", { defaultValue: "Sign up" })}
                </>
              )}
            </button>
          </form>
          ...
          <p className="mt-8 text-center text-sm text-gray-400">
            ...
            >
              {t("signup_page.login_link", { defaultValue: "Login here" })}{" "}
